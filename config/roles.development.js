/**
 * Discord role permissions configuration - DEVELOPMENT
 * Development-specific role IDs for testing
 */

export const roles = {
    // Administrator role - full access
    admin: {
        id: process.env.ROLE_ADMIN_ID || 'DEV_ADMIN_ROLE_ID',
        permissions: ['*']
    },

    // Moderator role - moderation commands
    moderator: {
        id: process.env.ROLE_MODERATOR_ID || 'DEV_MODERATOR_ROLE_ID',
        permissions: [
            'commands.moderate',
            'commands.warn',
            'commands.mute',
    ...
    staff: {
        id: process.env.ROLE_STAFF_ID || 'DEV_STAFF_ROLE_ID',
        permissions: [
            'commands.warn',
            'dashboard.view'
        ]
    ...
    member: {
        id: process.env.ROLE_MEMBER_ID || 'DEV_MEMBER_ROLE_ID',
        permissions: [
            'commands.basic'
        ]
    }
